...
use rand::Rng;
use tfhe::{Encryptor, KeyGen, bfhe::Evaluator};
...
pub fn criterion_benchmark(c: &mut Criterion) {
    ...
    // set parameter
    // let default_parameters = *tfhe::bfhe::BABYBEAR_BINARY_128_BITS_PARAMETERS;
    let default_parameters = *tfhe::bfhe::GOLDILOCKS_BINARY_128_BITS_PARAMETERS;
    // let default_parameters = *tfhe::bfhe::ZAMA_BINARY_128_BITS_PARAMETERS;
